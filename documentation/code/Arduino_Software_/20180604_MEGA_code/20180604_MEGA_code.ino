...
//Start Arm
const int Start_Arm_1 = 10;
const int Start_Arm_2 = 11;
const int Start_Arm_3 = 12;
const int Start_Arm_4 = 48;
//Target Arm
const int Target_Arm_1 = 42;
const int Target_Arm_2 = 43;
const int Target_Arm_3 = 44;
const int Target_Arm_4 = 45;
...
//signals for controling the UNO
  ...
  pinMode(Target_Arm_1,OUTPUT);
  pinMode(Target_Arm_2,OUTPUT);
  pinMode(Target_Arm_3,OUTPUT);
  pinMode(Target_Arm_4,OUTPUT);
  
  pinMode(Start_Arm_1,OUTPUT);
  pinMode(Start_Arm_2,OUTPUT);
  pinMode(Start_Arm_3,OUTPUT);
  pinMode(Start_Arm_4,OUTPUT);
